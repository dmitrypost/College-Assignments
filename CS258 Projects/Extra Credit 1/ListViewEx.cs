	...
	public class ListViewEx : ListView
	{
		...
		public new View View
		{
			...
			set
			{
				...
				foreach (EmbeddedControl ec in _embeddedControls)
					ec.Contrl.Visible = (value == View.Details);
			...
			switch (m.Msg)
			{
				case WM_PAINT:
					...
					foreach (EmbeddedControl ec in _embeddedControls)
					{
						...
						{
							ec.Contrl.Visible = false;
							continue;
						}
						else
						{
							ec.Contrl.Visible = true;
						}
						...
						switch (ec.Dock)
						{
							case DockStyle.Fill:
								break;
							case DockStyle.Top:
								rc.Height = ec.Contrl.Height;
								break;
							case DockStyle.Left:
								rc.Width = ec.Contrl.Width;
								break;
							case DockStyle.Bottom:
								rc.Offset(0, rc.Height-ec.Contrl.Height);
								rc.Height = ec.Contrl.Height;
								break;
							case DockStyle.Right:
								rc.Offset(rc.Width-ec.Contrl.Width, 0);
								rc.Width = ec.Contrl.Width;
								break;
							case DockStyle.None:
								rc.Size = ec.Contrl.Size;
								break;
						}
